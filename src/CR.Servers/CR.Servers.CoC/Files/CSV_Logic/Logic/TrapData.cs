...
﻿namespace CR.Servers.CoC.Files.CSV_Logic.Logic
{
    internal class TrapData : Data
    {
        ...
        internal CharacterData preferredTargetD;
        internal CharacterData spawnedCharGroundD;
        internal CharacterData spawnedCharAirD;

        public TrapData(Row rw, DataTable dt) : base(rw, dt)
        {
        }
        ...
        internal override void Process()
        {
            ...
            this.preferredTargetD = DataTables.GetCharacterByName(this.PreferredTarget);
            this.spawnedCharGroundD = DataTables.GetCharacterByName(this.SpawnedCharGround);
            this.spawnedCharAirD = DataTables.GetCharacterByName(this.SpawnedCharAir);
        }
